...
function Cart() {
  ...
  const totalAmount = () => {
    if (allCart.length > 0) {
      setTotal(
        allCart.map((items) => parseInt(items.rate)).reduce((r1, r2) => r1 + r2)
      );
    } else {
      setTotal(0);
    }
      ...
      <div>
        <div className="mt-24">
          <div className="row ms-3  me-2">
                  ...
                  ? allCart.map((item, index) => (
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <Button
                              className="btn bg-light border-light"
            ...
            <div
              className="col-lg-4 w-3/4 mt-5 border rounded border-secondary shadow"
              style={{ height: "15%" }}
            >
              ...
              <div className="ms-3 mt-3">
                <h5>
                  Total Items : <span>{allCart.length}</span>
                </h5>
                <h4 className="mb-4">
